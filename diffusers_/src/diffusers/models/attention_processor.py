...
class XFormersAttnProcessor:
    ...
    def __call__(
        ...
        # if key.shape[-2] == query.shape[-2] * 2:
        #     # sliced_attention_probs = torch.mean(attn.get_attention_scores(query, key, attention_mask), dim=0)
        #     sliced_attention_probs = attn.get_attention_scores(query, key, attention_mask)
        # else:
        ...
        return hidden_states#, sliced_attention_probs
