...
def log_validation(
    ...
    validation_prompt = "A photo of driving scene"
    
    for validation_seg in validation_segs:
        ...
        for _ in range(args.num_validation_images):
            ...
            image.save(f'{args.output_dir}/val_images/{step}.png')
            images.append(image)
        image_logs.append(
...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        "--real_images_path", type=str, default=None
    )
    parser.add_argument(
        "--seg_images_path", type=str, default=None
    )
    parser.add_argument(
        "--revision",
        type=str,
...
def collate_fn(examples):
    ...
    conditioning_pixel_values = torch.stack([example["seg_image"] for example in examples])
...
def main(args):
    ...
    train_dataset = RealSegDataset(
        ...
        seg_images_path=args.seg_images_path,
        img_size=(512, 512),
        seg_size=(512, 512),
